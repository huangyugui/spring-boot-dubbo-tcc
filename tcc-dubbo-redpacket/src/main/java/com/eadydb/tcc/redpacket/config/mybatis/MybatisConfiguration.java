package com.eadydb.tcc.redpacket.config.mybatis;

import com.eadydb.tcc.enums.DataSourceType;
import com.eadydb.tcc.redpacket.util.SpringContextUtil;
...
@MapperScan(basePackages = "com.eadydb.tcc.redpacket.mapper")
@Slf4j
